  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (error) {
        ...
        setFormSuccess(
          "Your message has been sent successfully! Thank you for reaching out. I appreciate your message and will get back to you as soon as possible."
        );
        setFormError(null);
        setName("");
        setEmail("");
      ...
      <div className="contact-info">
        ...
        <p>
          <em>
            ...
            idea, or just want to chat about the latest trends in web design and
